<!-- Modal -->
<div class="modal fade" id="shkeperluan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Surat Izin Setengah Hari Keperluan</h5>
                    ...
                    <div class="multisteps-form__content">
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="hidden" name="permission_type" value="setengah hari keperluan" />
