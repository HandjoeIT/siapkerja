                    ...
                    <div class="row">
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" novalidate="novalidate" method="POST"
                                action="{{ route('pegawai.store') }}" enctype="multipart/form-data">
                                @csrf
                                <!--single form panel-->
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active"
                                    data-animation="FadeIn">
                                    <h5 class="font-weight-bolder mb-0">Pegawai Baru</h5>
                                    <p class="mb-0 text-sm">Identitas Diri</p>
                                    <div class="multisteps-form__content">
                                        <div class="row mt-3">
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                    <img src="{{ asset('dashboard') }}/assets/img/img_selfie.png"
                                                        alt="...">
                                                </div>
                                                ...
                                                <div>
                                                    <span class="btn btn-rose btn-round btn-file">
                                                        ...
                                                        <input type="file" name="photo" maxsize="2"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12 col-sm-12 mt-3 mt-sm-0">
                                                <label>Alamat</label>
                                                <textarea class="multisteps-form__input form-control" name="address" id=""
